...
[![Version](https://img.shields.io/badge/Version-1.1.1-blue)](https://github.com/s4d0x-dev/safebox/releases)
...
1. **Download the Installer**:
   - Visit the [Releases](https://github.com/s4d0x-dev/safebox/releases) page and download `SafeBoxInstaller.exe` (version 1.1.1).
2. **Run the Installer**:
